"""
Standalone runner for quantum pulse control training.
Run this from the QuantumEEG directory.
"""
...
from quantum_pulse_control.trainer import train_snn_controller
from quantum_pulse_control.evaluator import evaluate_and_visualize
